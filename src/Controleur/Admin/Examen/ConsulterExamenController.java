 ...
 * @author asus
 */
public class ConsulterExamenController implements Initializable {
    ...
    @FXML
    private TableColumn<Examen, Integer> tv_ListExamen_cl_Prix;
    ...
    public void Tableau() {
        ...
        this.tv_ListExamen_cl_TypeExamen.setCellFactory(ComboBoxTableCell.<Examen, String>forTableColumn("Scanner", "IRM", "Echographie","NFS", "BILAN", "CARDIO"));
        ...
        this.tv_ListExamen_cl_Prix.setCellFactory(TextFieldTableCell.<Examen,Integer>forTableColumn(new IntegerStringConverter()));
        tv_ListExamen_cl_Prix.setOnEditCommit(
                (TableColumn.CellEditEvent<Examen, Integer> t) -> {
                    ((Examen) t.getTableView().getItems().get(
            ...
            TableCell<Examen, Date> cell = new TableCell<Examen, Date>() {
                ...
                protected void updateItem(Date item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        System.out.println("upd -- "+item.toString());
