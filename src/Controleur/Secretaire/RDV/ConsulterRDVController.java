...
public class ConsulterRDVController implements Initializable {
    ...
    @FXML
    private TableColumn<Patient, String> tv_ListExamen_cl_NomP;

    @FXML
    TableColumn dateColumn = new TableColumn("dateRendezVous");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        listRendezVous(RendezVousDao.findAllRendezVous());
        Tableau();
    }
