 ...
 * @author asus
 */
public class AdminControleur implements Initializable {
    ...
    @FXML
    void handlhome(ActionEvent event) throws IOException {
        menu.getChildren().removeAll(menu.getChildren());
        menu.getChildren().add((Node) FXMLLoader.load(getClass().getClassLoader().getResource("View/MenuAccueil.fxml")));
    }
