 ...
 * @author asus
 */
public class ConsulterSecretaireController implements Initializable {
    ...
    public void SupprimerSecretaire() {
        ...
        listEmployer(Admin.findAllSecretaire());
    ...
    public void listEmployer(List<Employer> users) {
        ObservableList<Employer> hotel = FXCollections.observableArrayList(users);
        this.tableusers.setItems(hotel);
    }
